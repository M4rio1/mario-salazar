...
export const Hero = () => {
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 w-full h-screen pointer-events-none [mask-image:radial-gradient(200%_100%_at_50%_120%,transparent_0%,transparent_47%,black_50%,black_100%)] [mask-mode:alpha]">
        <SparklesCore
