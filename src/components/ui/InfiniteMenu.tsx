...
class ArcballControl {
  ...
  public update(deltaTime: number, targetFrameDuration = 16): void {
    ...
    if (this.isPointerDown) {
      const ANGLE_AMPLIFICATION = 1 / timeScale;
      ...
      if (vec2.sqrLen(midPointerPos) > this.EPSILON) {
        ...
        const autoRotation = quat.setAxisAngle(
          quat.create(),
          vec3.fromValues(1, 1, 0), // Eje Y para rotación horizontal
          autoRotationSpeed * timeScale
        );
        quat.multiply(this.orientation, autoRotation, this.orientation);
      }
    }
