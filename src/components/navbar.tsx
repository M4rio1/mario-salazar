        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute top-full left-0 mt-4 w-full bg-gradient-to-b from-gray-900 to-gray-950 rounded-xl p-6 flex flex-col gap-6 shadow-xl md:hidden z-50 border border-gray-700 backdrop-blur-md"
            >
